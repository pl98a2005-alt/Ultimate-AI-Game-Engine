...
class SovereignEngineer(App):
    def build(self):
        # تحميل الخط لضمان عدم ظهور مربعات [cite: 2026-01-11]
        ...
        self.blueprint_input = TextInput(
            hint_text="صف اللعبة التي تريدها هنا...",
    ...
    def smart_cleanup(self, instance):
        ...
        self.log_to_console("تم تنظيف الذاكرة المؤقتة وحفظ الخبرات.") [cite: 2026-01-13]
